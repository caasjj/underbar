...
describe( "reduce", function () {
	...
	it( "should be able to sum up an array without being provided an initial value (as long as the array contains at least one element)",
	    function () {
...
describe( "sortBy", function () {
	...
	it( "should produce results that change the order of the list as little as possible", function () {
		...
		var collection = [
			new Pair( 1, 1 ), new Pair( 1, 2 ), new Pair( 1, 3 ), new Pair( 1, 4 ), new Pair( 1, 5 ), new Pair( 1, 6 ),
			new Pair( 2, 1 ), new Pair( 2, 2 ), new Pair( 2, 3 ), new Pair( 2, 4 ), new Pair( 2, 5 ), new Pair( 2, 6 ),
			new Pair( undefined, 1 ), new Pair( undefined, 2 ), new Pair( undefined, 3 ), new Pair( undefined, 4 ),
...
describe( "bind", function () {
	it( "should invoke func in the correct context", function (done) {
